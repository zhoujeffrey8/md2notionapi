...
/** Property **/
export declare type PostResult = Extract<QueryDatabaseResponse['results'][number], {
...
export declare type ExtractedPropertyValue<TType extends PropertyValueType> = Extract<PropertyValue, {
    type: TType;
}>;
...
/** People **/
export declare type PropertyValueUser = Extract<PropertyValuePeople['people'][number], {
    type: string;
}>;
export declare type PropertyValueUserType = PropertyValueUser['type'];
export declare type PropertyValueUserPerson = Extract<PropertyValueUser, {
    type: 'person';
}>;
export declare type PropertyValueUserBot = Extract<PropertyValueUser, {
    type: 'bot';
}>;
/** Block **/
export declare type Block = Extract<ListBlockChildrenResponse['results'][number], {
    type: string;
}>;
export declare type BlockType = Block['type'];
export declare type ExtractedBlockType<TType extends BlockType> = Extract<Block, {
    type: TType;
}>;
...
export declare type ExtractedRichText<TType extends RichTextType> = Extract<RichText, {
    type: TType;
}>;
...
export declare type ExtractedFile<TType extends FileType> = Extract<File, {
    type: TType;
}>;
...
export declare type CalloutIconType = CalloutIcon['type'];
export declare type ExtractedCalloutIcon<TType extends CalloutIconType> = Extract<CalloutIcon, {
    type: TType;
}>;
